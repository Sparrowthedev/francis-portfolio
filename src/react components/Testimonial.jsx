    ...
    <section id="testimonials" class="testimonials">
        ...
        <div class="container">
            <div class="row text-center text-white">
                ...
                <hr  class="mx-auto c-hr"/>
                <p class="lead mt-1">What my clients are saying</p>
            </div>
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            ...
                            <div class="testimonials__card">
                                <p class="lh-lg">
                                    ...
                                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Excepturi rem vero quos
                                    placeat perferendis aspernatur saepe a, voluptatibus corrupti ipsam inventore.
                        ...
                        <div class="carousel-item">
                            ...
                            <div class="testimonials__card">
                             ...
                             {/* CLIENT PICTURE  */}
                            <div class="testimonials__pic">
                                <img src="images/testimonials/client-2.jpg" alt="client-2"
                                    class="rounded-circle img-fluid"/>
                            </div>
                             {/* client name and role  */}
                            <div class="testimonials__name">
                        ...
                        <div class="carousel-item">
                            ...
                            <div class="testimonials__card">
                             ...
                             {/* CLIENT PICTURE  */}
                            <div class="testimonials__pic">
                                <img src="images/testimonials/client-3.jpg" alt="client-3"
                                    class="rounded-circle img-fluid"/>
                            </div>
                             {/* client name and role  */}
                            <div class="testimonials__name">
                        ...
                        <div class="carousel-item">
                            ...
                            <div class="testimonials__card">
                             ...
                             {/* CLIENT PICTURE  */}
                            <div class="testimonials__pic">
                                <img src="images/testimonials/client-4.jpg" alt="client-4"
                                    class="rounded-circle img-fluid"/>
                            </div>
                             {/* client name and role  */}
                            <div class="testimonials__name">
                        ...
                        <div class="carousel-item">
                            ...
                            {/* CLIENT PICTURE */}
                            <div class="testimonials__pic">
                                <img src="images/testimonials/client-5.jpg" alt="client-5"
                                    class="rounded-circle img-fluid"/>
                            </div>
                            {/*  client name and role  */}
                            <div class="testimonials__name">
                                <h3>Edward John</h3>
                                <p class="fw-light">Tech Analyst</p>
                            </div>
                        </div>
